...
export default function ContentManager() {
  ...
  return (
    <div style={{ minHeight: "100vh", background: "#f1f5f9" }}>
      ...
      <div
        style={{ maxWidth: "640px", margin: "0 auto", padding: "32px 24px" }}
      >
        <div
          style={{
            background: "#FFFFFF",
        ...
        >
          ...
          >
            ...
            state and require approval before appearing publicly.
          </p>
