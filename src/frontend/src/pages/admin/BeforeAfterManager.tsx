...
import {
  useAddBeforeAfterPair,
  useGetAllBeforeAfterPairs,
...
export default function BeforeAfterManager() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const beforeBlob = ExternalBlob.fromBytes(beforeBytes).withUploadProgress(
        (p) => setUploadProgress((prev) => ({ ...prev, before: p })),
      );
      const afterBlob = ExternalBlob.fromBytes(afterBytes).withUploadProgress(
        (p) => setUploadProgress((prev) => ({ ...prev, after: p })),
      );
