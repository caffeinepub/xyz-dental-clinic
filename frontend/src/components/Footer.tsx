...
export default function Footer() {
  ...
  const appId = encodeURIComponent(window.location.hostname || 'xyz-dental-clinic');
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            <div>
              <div className="flex items-center gap-2 mb-4">
                ...
                <div>
                  <p className="font-bold text-white text-lg">XYZ Dental Clinic</p>
                  <p className="text-xs text-gray-400">Your Smile, Our Priority</p>
                </div>
              </div>
              <p className="text-sm text-gray-400 leading-relaxed">
                Providing exceptional dental care with the latest technology and a gentle touch.
              </p>
            </div>
            ...
            <div>
              ...
              <ul className="space-y-2">
                {['Invisalign', 'Dental Implants', 'Laser Dentistry', 'Pediatric Dentistry', 'Smile Makeover'].map((s) => (
                  <li key={s}>
          ...
          <div className="border-t border-gray-800 mt-10 pt-6 flex flex-col sm:flex-row items-center justify-between gap-4">
            <p className="text-xs text-gray-500">
              © {year} XYZ Dental Clinic. All rights reserved.
            </p>
            <p className="text-xs text-gray-500">
              Built with ❤️ using{' '}
              <a
