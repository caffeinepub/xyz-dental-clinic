    ...
    <section className="py-20 bg-gray-900" ref={sectionRef}>
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-10">
          <span className="text-blue-400 font-semibold text-sm uppercase tracking-wider">Real Results</span>
          <h2 className="text-3xl sm:text-4xl font-bold text-white mt-2 mb-4">
            Before & After
          </h2>
          <p className="text-gray-400 max-w-xl mx-auto">
            Drag the slider to see the transformation. Real patients, real results.
          </p>
        </div>
          ...
          >
            <div className="absolute top-1/2 -translate-y-1/2 -translate-x-1/2 w-10 h-10 bg-white rounded-full shadow-xl flex items-center justify-center">
              <svg width="20" height="20" viewBox="0 0 20 20" fill="none">
                <path d="M7 5L2 10L7 15M13 5L18 10L13 15" stroke="#1e40af" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
              </svg>
            </div>
          </div>

          {/* Labels */}
          <div className="absolute top-4 left-4 bg-black/60 text-white text-xs font-bold px-3 py-1 rounded-full">BEFORE</div>
          <div className="absolute top-4 right-4 bg-blue-600/80 text-white text-xs font-bold px-3 py-1 rounded-full">AFTER</div>
        </div>
      </div>
    </section>
  );
